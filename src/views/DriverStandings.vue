...
import { driverCodePhoto, constructorIdTeamColor, constructorIdTeamLogo } from '@/mappings'

const { driverStandings, isLoaded } = storeToRefs(useDriverStandingsStore())

const getLatestConstructorId = (standing) => {
...
<template>
  ...
  <div v-else class="flex flex-col w-full">
    <template v-for="standing in driverStandings" :key="standing.Driver.driverId">
      ...
      <div
        ...
        <div class="p-1 h-16 aspect-square">
          <div class="overflow-hidden rounded-full"
               :class="constructorIdTeamColor[getLatestConstructorId(standing)]?.bg">
            <img class="h-full w-full object-center object-contain"
        ...
        <div class="flex flex-col ml-4">
          ...
          <div class="flex gap-2">
            <img class="h-4" :src="constructorIdTeamLogo[getLatestConstructorId(standing)]"/>
